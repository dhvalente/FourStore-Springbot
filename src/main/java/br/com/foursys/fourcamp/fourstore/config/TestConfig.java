...
public class TestConfig implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Product p1 = new Product(null, "Camiseta Vermelha Manga Curta GG", "50", "40", "43", 20.00, 65.00);
		Product p2 = new Product(null, "Vestido Amarelo XG", "55", "40","45", 35.00, 110.00);
		Product p3 = new Product(null, "Bermuda Preta G2", "54" , "43", "52", 25.00, 45.00);
		Product p4 = new Product(null, "Alguma Coisa Cinza","57", "41", "48", 10.00, 35.00);
		Product p5 = new Product(null, "Camiseta Ceral Radical" , "54", "40", "37", 55.00, 70.00); 
